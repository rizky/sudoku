...
int		ft_check_number(int **board, int row, int col, int number)
{
	int i;
	int j;
	int base_row;
...
int		ft_is_available(int **board, int row, int col, int number)
{
	int i;
...
int		ft_mcv_heuristic(int **board, int *row, int *col)
{
	int	heu[3];
	int	i;
	int	j;
...
int		ft_put_number(int **board, int row, int col, int *solution)
{
	int number;
